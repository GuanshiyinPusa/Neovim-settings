return {
	{
		...
		config = function()
			...
			-- Align flake8 with black so they don't fight each other.
			-- E203: whitespace before ':', black disagrees with PEP8 here
			-- W503: line break before binary operator, black prefers this style
			lint.linters.flake8.args = vim.list_extend(
				vim.deepcopy(lint.linters.flake8.args or {}),
